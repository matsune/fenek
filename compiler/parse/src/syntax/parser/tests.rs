...
fn test_parse_expr1() {
    ...
    // assert_eq!(rhs.rhs.into_lit().raw, "2");
}
...
//     assert_eq!(lhs.lhs.into_lit().raw, "1");
//     assert_eq!(lhs.rhs.into_ident().raw, "a");
//     assert_eq!(binary.rhs.into_lit().raw, "2");
// }
...
//     assert_eq!(rhs_binary.lhs.into_lit().raw, "3");
...
//     assert_eq!(rhs_lhs_binary.rhs.into_lit().raw, "2");
// }
...
//     assert_eq!(lhs_binary.rhs.into_lit().raw, "1");
//     let lhs_lhs_binary = lhs_binary.lhs.into_binary();
//     assert_eq!(lhs_lhs_binary.op, BinOp::Sub);
//     assert_eq!(lhs_lhs_binary.lhs.into_lit().raw, "4");
//     assert_eq!(lhs_lhs_binary.rhs.into_lit().raw, "3");
// }
...
//     assert_eq!(binary.op, BinOp::Sub);
//     assert_eq!(binary.lhs.into_lit().raw, "4");
//     assert_eq!(binary.rhs.into_lit().raw, "3");
// }
...
//     assert_eq!(var_decl.init.into_lit().raw, "3");
// }
